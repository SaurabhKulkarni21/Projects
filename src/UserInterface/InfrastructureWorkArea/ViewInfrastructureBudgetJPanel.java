 ...
 * @author amaha
 */
public class ViewInfrastructureBudgetJPanel extends javax.swing.JPanel {
    ...
    public ViewInfrastructureBudgetJPanel(JPanel userProcessContainer, Enterprise enterprise, UserAccount userAccount, EcoSystem business) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.enterprise = enterprise;
        this.userAccount = userAccount;
        this.business = business;
        populateInfraBudgetTable();
    }

    private void populateInfraBudgetTable() {
        DefaultTableModel model = (DefaultTableModel) tblDisplayInfraBudget.getModel();
